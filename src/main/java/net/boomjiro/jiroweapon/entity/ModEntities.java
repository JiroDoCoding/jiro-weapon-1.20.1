...
public class ModEntities {
    ...
    public static final EntityType<ReaperSkullProjectileEntity> REAPER_SKULL =
            Registry.register(
                    ...
                    new Identifier(JiroWeapon.MOD_ID, "reaper_skull"),
    ...
    public static final EntityType<RitualCircleEntity> RITUAL_CIRCLE =
            Registry.register(
                    Registries.ENTITY_TYPE,
                    new Identifier(JiroWeapon.MOD_ID, "ritual_circle"),
    ...
    public static final EntityType<IllusionBlockEntity> ILLUSION_BLOCK = Registry.register(
            Registries.ENTITY_TYPE,
            new Identifier("jiroweapon", "illusion_block"),
            FabricEntityTypeBuilder.<IllusionBlockEntity>create()
                    .entityFactory(IllusionBlockEntity::new)
